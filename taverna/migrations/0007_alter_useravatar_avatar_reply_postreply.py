...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('taverna', '0006_alter_useravatar_avatar_alter_useravatar_user_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='taverna.reply')),
            ],
        ),
    ]
